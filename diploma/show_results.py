...
def main(arguments):
    ...
    visualizer = Visualizer(
        agents_number, env_name, agent, metrics_number_of_elements, 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--agents_number', type=int, default=1)
    ...
    parser.add_argument('--metrics_number_of_elements', type=int, default=10)
    parser.add_argument('--metrics_number_of_iterations', type=int, default=1)
